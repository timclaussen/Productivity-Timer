...
class Application(labeler.Lbl_Bttn):
...
#        self.columnconfigure()
    ...
    def create_widgets(self):
        ...
        self.lbl.grid()
        self.lbl_1 = self.make_label(1, 1, "YouTube Time") #self is implicit first arg
        self.lbl_2 = self.make_label(1, 4, "Video Game Time") 
        self.lbl_3 = self.make_label(1, 7, "Productive") 
    ...
    def update_bttn(self, bttn_num, lbl):
        ...
        if(bttn_num == 1): #button 1 update
            if(self.bttn1_time == 0): #start timer
                ...
                self.total_1 = self.total_1 + (int(time.time()) - self.bttn1_time)/60
